...
int main(){
    ...
    Category category3("literature");

    Writer writer1("Jafor Iqbal");
    Writer writer2("John");
    Writer writer3("Kazi Nazrul");

    Book book1("Ikaras", category1, writer1, 400.00, "sc007", 500);
    Book book2("Internet of Things", category2, writer2, 600.00, "tc577", 400);
    Book book3("shiulimala", category3, writer3, 300.00, "lt433", 300);
    ...
    Customer customer1("Shima", "Comilla");
    customer1.display();
